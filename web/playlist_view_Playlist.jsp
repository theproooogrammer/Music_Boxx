                ...
                <div class="col-lg-3 col-md-4 col-sm-6 portfolio-item">
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <h1><a href="playlist_view_playlistsongs.jsp?playn=<%=result_playlist_view_Playlist.getString("pname")%>"><%=result_playlist_view_Playlist.getString("pname")%></a></h1>
                            <br><table>
                                <tr>
                                    <td width="200"><h5>PlayList <%=count%></h5></td>
                                    <td><a style="color:red" href="playlist_remove_playlist.jsp?playn=<%=result_playlist_view_Playlist.getString("pname")%>">Delete</a></td>
                                </tr>
