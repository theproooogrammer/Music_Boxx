                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownBlog">
                                ...
                                <a class="dropdown-item" href="suggestlist.jsp?var=suggestlist">Suggestion</a>
                            </div>
                        </li>
                        <li class="nav-item">
                            ...
                            <div>
                                <div class="input-group">
                                    <form class="form-inline my-2 my-lg-0" action="search.jsp" method="post">
                                        <input type="text" name="lyrics" class="form-control" placeholder="Search for...">
                        ...
                        <li  class="nav-item">
                            <a class="nav-link" href="loginUI.jsp ">Login</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="signupUI.jsp">Sign Up</a>
                        </li>
                    </ul>
                </div>
            </div>
