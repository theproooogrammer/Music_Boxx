...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <%
                try {
                    ...
                    ResultSet resultRS = recentlyPlayed.get_recently_played_Only4(username);
            ...
            <div class="row">
                <%            String alpath;
                    ...
                    while (resultRS.next()) {
                        ...
                        while (resultRS1.next()) {
                            ...
                            System.out.println("recently_searchedonly4"+resultRS1.getString("sname"));
                %>
                <div class="col-lg-3 col-md-4 col-sm-6 portfolio-item">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            <a href="search.jsp?playn=<%=resultRS1.getString("sname")%>"><%=resultRS1.getString("sname")%></a>
                        </div>
                    </div>
                </div>
                <%
        ...
        <%
                ...
                System.out.println("recently_searchedonly4 Error" + e);
            }
